...
function joinConf(name) {
    ...
    connectedConversation.on('streamAdded', function(stream) {
        ...
        stream.addInDiv('remote-container-outgoing', 'remote-media-outgoing-' + stream.streamId, {}, false);
        
        document.getElementById('remote-container-incoming').innerHTML = ''
        stream.addInDiv('remote-container-incoming', 'remote-media-incoming-' + stream.streamId, {}, false);
